...
class CreamyBaconBuilder:
    ...
    def add_topping(self):
        ...
        self.pizza.topping.append([i for i in (PizzaTopping.mozzarella, PizzaTopping.bacon, PizzaTopping.ham,
...
def validate_style(builders):
    try:
        ...
        print('Sorry, only margatita (key m) and creamy bacon (key c) are available')
        return False, None
    return True, builder
